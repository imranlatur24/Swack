...
import com.swack.customer.model.SupportListModel;
...
public class Support extends BaseActivity implements OnMapReadyCallback {
    ...
    private static ArrayList<SupportListModel> templistview;
...
//        swipeContainer.setRefreshing(false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(location).title(getResources().getString(R.string.app_name_pvt)));
