...
import com.swack.customer.data.SharedPreferenceManager;
...
public class BaseActivity extends AppCompatActivity {
	...
	public void errorOut(Throwable t){
		if(!isNetworkAvailable()){
			...
			Toasty.error(getApplicationContext(), getResources().getString(R.string.error_msg_unknown) + t, Toasty.LENGTH_LONG).show();
		}
	}
