...
import com.swack.customer.adapter.GridViewAdapter;
import com.swack.customer.adapter.SlidingImageAdapter;
...
import com.swack.customer.view.MyTextView;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener,
  ...
  //  private TextToSpeech mTTS;
    ...
    public String lati, longi,gar_id,gar_list_id,gar_name,cus_pic,gar_ids;
    ...
    private void init() {
        ...
        System.out.println("#CUS PIC : "+cus_pic);
        ...
        gridViewAdapter = new GridViewAdapter(MainActivity.this,gar_id,fullAddress,lattti,lonnngi);
       ...
       // imageView.setImageURI(Uri.parse(cus_pic));
...
//Set circle indicator radius
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_vehicle) {
            ...
            startActivity(new Intent(MainActivity.this,OrderHistoryActivity2.class));
        } if (id == R.id.nav_ongoing) {
            Intent intent = new Intent(MainActivity.this,OrderHistoryActivity3.class);
            ...
            startActivity(new Intent(MainActivity.this,OrderListProcessClass.class));
           ...
           startActivity(new Intent(MainActivity.this,Support.class));
            ...
            //Toast.makeText(context, "do you want to logout?", Toast.LENGTH_SHORT).show();
            ...
            alertDialogBuilder.setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    ...
                    /*mTTS.speak("logout done successfully..", TextToSpeech.QUEUE_ADD, null, null);
                    mTTS.setPitch((float)0.8);
                    mTTS.setSpeechRate((float)0.2);*/
                    Toasty.success(getApplicationContext(),"logout done successfully..",Toasty.LENGTH_SHORT).show();
            ...
            sharingIntent.putExtra(Intent.EXTRA_TEXT, getResources().getString(R.string.app_name)+" App\nClick here https://play.google.com/store/apps/details?id=com.swack.customer to download the app");
...
//        swipeContainer.setRefreshing(false);
    ...
    public void address() {
        ...
        try {
            ...
            admin_area = addressList.get(0).getAdminArea();
            System.out.println("Address Here : "+city+area+admin_area);
    ...
    public void onLocationChanged(Location location) {
        ...
        prefManager.closeDB();
        lattti  = Double.toString(location.getLatitude());
        lonnngi = Double.toString(location.getLongitude());

      /*  if(lattti == null && lonnngi == null){
            progressDialog = new ProgressDialog(context);
            progressDialog.setMessage("Please Wait...");
            progressDialog.setProgress(150000);
            progressDialog.setCancelable(false);
            progressDialog.show();
   ...
   /* @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (locButton != null) {
            locButton.setImageResource(R.drawable.ic_driver);
