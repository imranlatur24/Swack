...
public class FinalBillAdapter extends RecyclerView.Adapter<FinalBillAdapter.MyViewHolder> {
    ...
    private ArrayList<Order> arrayLists;
    private ArrayList<Order> tempArrayLists;

    public FinalBillAdapter(OrderHistoryActivity context) {
        this.context = context;
    }

    public void setListArray(ArrayList<Order> arrayLists) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        final Order mOrder = arrayLists.get(position);
