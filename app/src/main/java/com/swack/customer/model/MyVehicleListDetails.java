...
public class MyVehicleListDetails {
    private String response;
    private ArrayList<MyVehicleListDetails> MyVehicleDetailsList;
    ...
    private String vehicle_fc_expdate;

    public ArrayList<MyVehicleListDetails> getMyVehicleDetailsList() {
        return MyVehicleDetailsList;
    }

    public void setMyVehicleDetailsList(ArrayList<MyVehicleListDetails> myVehicleDetailsList) {
        MyVehicleDetailsList = myVehicleDetailsList;
    }

    public String getVehicle_fc_expdate() {
        return vehicle_fc_expdate;
    }

    public void setVehicle_fc_expdate(String vehicle_fc_expdate) {
        this.vehicle_fc_expdate = vehicle_fc_expdate;
    }
