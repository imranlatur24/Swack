...
public class MyVehicleList {
    ...
    private ArrayList<MyVehicleList> VehicleDetailsList;
    ...
    public ArrayList<MyVehicleList> getVehicleDetailsList() {
        return VehicleDetailsList;
    }

    public void setVehicleDetailsList(ArrayList<MyVehicleList> vehicleDetailsList) {
